# CyberArk Certificate and Key Policy Specification
...
| `rsaKeySize`       | integer     | Number of bits that should be used by default for RSA keys: 1024, 2048, 3072, or 4096                                                                 |
...
| `rsaKeySizes`      | array of integer | Permitted number of bits for RSA keys: `1024`, `2048`, `3072`, and/or `4096`                        |
