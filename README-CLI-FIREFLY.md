...
| `--platform`                                                                                            | (REQUIRED) Use to specify the Venafi platform.<br/>Example: `--platform firefly`                                                                                                                                                                                                                                                      |
...
| `--platform`                                                                                            | (REQUIRED) Use to specify the Venafi platform. The value to set is 'oidc'.<br/>Example: `--platform oidc`                                                                                                                                                                |
...
Example
```
vcert getcred ---platform oidc --token-url <idp token url> --client-id <idp client id> --client-secret <idp client secret> --audience <idp audience> --scope <idp scopes> --format text
```
...
Example
```
vcert getcred ---platform oidc --token-url <idp token url> --client-id <idp client id> --device-url <idp device url> --audience <idp audience> --scope <idp scopes> --format text
```
...
Example
```
vcert getcred ---platform oidc --token-url <idp token url> --client-id <idp client id> --username <idp username> --username <idp user's password> --audience <idp audience> --scope <idp scopes> --format text
```
