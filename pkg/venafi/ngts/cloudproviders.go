...
func (c *Connector) ProvisionCertificateToMachineIdentity(req domain.ProvisioningRequest) (*domain.ProvisioningMetadata, error) {
	...
	// Is certificate generated by Palo Alto Networks Next-Gen Trust Security (NGTS)?
	log.Printf("validating if certificate is generated by Palo Alto Networks Next-Gen Trust Security (NGTS)")
	err := c.validateCertificate(certificateID)
	if err != nil {
		return nil, err
	}
	log.Println("Certificate is Palo Alto Networks Next-Gen Trust Security (NGTS) generated")
...
func (c *Connector) validateCertificate(certificateId string) error {
	...
	log.Printf("Validating if certificate is generated by Palo Alto Networks Next-Gen Trust Security (NGTS)")
	if cert.DekHash == "" {
		return fmt.Errorf("error trying to provisioning certificate with ID: %s. Provided certificate is not Palo Alto Networks Next-Gen Trust Security (NGTS) generated", certificateId)
	}
	log.Println("Certificate is valid for provisioning (Palo Alto Networks Next-Gen Trust Security (NGTS) generated)")
	return nil
}
