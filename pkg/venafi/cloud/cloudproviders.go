...
func (c *Connector) ProvisionCertificateToMachineIdentity(req domain.ProvisioningRequest) (*domain.ProvisioningMetadata, error) {
	...
	// Is certificate generated by CyberArk Certificate Manager, SaaS?
	log.Printf("validating if certificate is generated by CyberArk Certificate Manager, SaaS")
	err := c.validateCertificate(certificateID)
	if err != nil {
		return nil, err
	}
	log.Println("Certificate is CyberArk Certificate Manager, SaaS generated")
...
func (c *Connector) validateCertificate(certificateId string) error {
	...
	log.Printf("Validating if certificate is generated by CyberArk Certificate Manager, SaaS")
	if cert.DekHash == "" {
		return fmt.Errorf("error trying to provisioning certificate with ID: %s. Provided certificate is not CyberArk Certificate Manager, SaaS generated", certificateId)
	}
	log.Println("Certificate is valid for provisioning (CyberArk Certificate Manager, SaaS generated)")
	return nil
}
