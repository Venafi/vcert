...
func init() {
	...
	ctx.TPPRefreshToken = resp.RefreshToken
	ctx.TPPaccessToken = resp.AccessToken
}
...
func TestRetrieveSystemVersion(t *testing.T) {
	...
	err = tpp.Authenticate(&endpoint.Authentication{AccessToken: refreshToken.AccessToken})
	if err != nil {
